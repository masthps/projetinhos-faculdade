 ...
 */
public class ArvoreBB<Key extends Comparable<Key>, Value> implements BinaryTree<Key, Value> {

    // raiz da árvore
    private BinaryTree.Node<Key, Value> root;
    ...
    private BinaryTree.Node<Key, Value> delete( BinaryTree.Node<Key, Value> node, Key key ) {
        ...
        if ( node != null ) {
            ...
            BinaryTree.Node<Key, Value> temp;
            int comp = key.compareTo( node.key );
            ...
            if ( comp == 0 ) {
                ...
                // o nó a ser removido tem filhos em ambos os lados
                    ...
                    // será inserida
                    temp = node.right;
                    BinaryTree.Node<Key, Value> min = temp;
    ...
    @Override
    public Iterable<SymbolTable.Entry<Key, Value>> traverse( TraversalTypes type ) {
    ...
    private void preOrder( BinaryTree.Node<Key, Value> node, String ident, String leftRight, StringBuilder sb ) {
