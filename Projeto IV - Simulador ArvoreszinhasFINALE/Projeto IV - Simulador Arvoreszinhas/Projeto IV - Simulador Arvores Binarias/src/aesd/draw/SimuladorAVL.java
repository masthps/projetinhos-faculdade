...
public class SimuladorAVL {
    ...
    public SimuladorAVL(EngineFrame engine) {
        this.engine = engine;
    ...
    private boolean wouldExceedMaxLevel(int value) {
        BinaryTree.Node<Integer, String> parent = findInsertionParent(getRoot(), value, 0);
        if (parent == null) {
            return false; 
        }
    ...
    private BinaryTree.Node<Integer, String> findInsertionParent(BinaryTree.Node<Integer, String> node, int value, int currentLevel) {
    ...
    private BinaryTree.Node<Integer, String> getRoot() {
        try {
            java.lang.reflect.Field rootField = ArvoreAVL.class.getDeclaredField("root");
    ...
    private BinaryTree.Node<Integer, String> findNodeByKey(BinaryTree.Node<Integer, String> node, int key) {
        if (node == null) return null;
    ...
    private int calculateLevelFromRoot(BinaryTree.Node<Integer, String> current, 
                                      BinaryTree.Node<Integer, String> target, int currentLevel) {
